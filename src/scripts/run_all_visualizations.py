...
class VisualizationSuiteRunner:
    ...
    def __init__(self):
        self.scripts = [
            ("src/scripts/enhance_performance_metrics.py", "Enhanced Metrics Calculation"),
            ("src/visualization/comprehensive_metrics_dashboard.py", "Comprehensive Metrics Dashboard"),
            ("src/visualization/a4_optimized_visualizer.py", "A4-Optimized Visualizations"),
            ("src/analysis/advanced_model_analysis.py", "Advanced Scientific Analysis")
        ]
